...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-start justify-between bg-opacity-0">
      <div className="z-10 w-full max-w-5xl justify-between font-mono text-sm lg:flex flex-col gap-8 p-8 bg-opacity-0">
